...
export const BILLING_VARIABLES = [...TOKEN_VARIABLES, 'image_count', 'effort'] as const;
export type BillingVariable = (typeof BILLING_VARIABLES)[number];
export const TIME_FUNCTIONS = ['hour', 'minute', 'weekday', 'month', 'day'] as const;
...
export type DiagnosticCode =
  'syntax' | 'unsupported' | 'missing_context' | 'type' | 'number' | 'limit';
