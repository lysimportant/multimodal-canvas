...
2026-09-11 最新节点无边框外观、Key 完整删除及设置清理已通过本地联合验收，恢复与验证记录见 [节点与设置清理检查点](docs/node-settings-cleanup-checkpoint.md)。

2026-09-10 最新登录找回密码、模型记忆及参数体验工作已完成本地联合验收，恢复入口与完整证据见 [登录与节点体验检查点](docs/auth-node-experience-checkpoint.md)。
